{<img src="https://secure.travis-ci.org/ning/maven-duplicate-finder-plugin.png?branch=master)" alt="Build Status">}[http://travis-ci.org/ning/maven-duplicate-finder-plugin]
