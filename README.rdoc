...
By providing an <tt>outputFileName</tt> configuration item (or by passing it as a system property to the mvn process) you can have the plugin redirect its output in a CSV format to a file.

The output will look like this and contains
