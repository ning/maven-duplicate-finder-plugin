{<img src="https://secure.travis-ci.org/typekpb/maven-duplicate-finder-plugin.png?branch=master)" alt="Build Status">}[http://travis-ci.org/typekpb/maven-duplicate-finder-plugin]
